...
public:
	...
	*/
	...
	static void SetEnterForSpace(bool b)					{ considerEnterForSpace = b;}

	/// Return the current white space setting.
	static bool IsWhiteSpaceCondensed()						{ return condenseWhiteSpace; }
	static bool IsEnterForSpace()							{ return considerEnterForSpace;}
...
protected:
	...
	inline static bool	IsWhiteSpace( int c )		{ return isspace( c )!= 0 || (considerEnterForSpace && (c == '\n' || c == '\r' )); }
...
private:
	...
	static bool	considerEnterForSpace;
};
...
public:
	...
	const bool       BoolValue() const;									///< Return the value of this attribute, converted to an bool.
	...
	void SetBoolValue( bool value );										///< Set the value from an integer.
...
public:
	...
	/// Load from a string using the current document value.
	bool LoadStr(const std::string& xmlstr);
