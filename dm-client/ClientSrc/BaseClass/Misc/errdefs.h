...
enum LoginServerErrCode
{
	...
	LSERR_Sys_Failure             	/*2001    */,	//无法连接到服务器
	...
	LSERR_Reserve_Overdue         	/*2009    */,	//您的密宝即将到期，\n请您用一块新的密宝到http://ekey.sdo.com\n上替换您现在用的密宝，或者停用您现在的\n密宝，否则您和这块密宝相关的帐号都将\n被锁定两个星期，其后系统会将帐号和密宝自动\n解绑，如有疑问，请访问网站http://ekey.sdo.com，或于\n我们的客服(021-50504729)热线联系。
	LSERR_Other_Area              	/*2010    */,	//此盛大通行证在其它区已登录
	LSERR_Ekey_Warp               	/*2011    */,	//您输入的密宝密码错误。\n请您访问网站http://ekey.sdo.com/ekey/OP_Userinfo.asp查询您的密宝资料，\n确定您绑定了此帐号。\n如有疑问，请和我们的客服热线（021-50504729）联系。
	LSERR_Has_Verfity             	/*2012    */,	//密码不正确，请重新输入密码
	LSERR_Not_Support_SDOA        	/*2013    */,	//不支持的登录请求！
	LSERR_Not_Support_Email       	/*2014    */,	//系统不支持邮箱帐号登录，请使用PT帐号登录
	LSERR_Refuse                  	/*2015    */,	//封测期间仅限“封闭测试账号”登陆，\n未获得“封闭测试账号”的玩家\n请于12月4日14时登陆开放测试区。\n《传世群英传》期待您的光临！
	LSERR_Only_For_TestAccount    	/*2016    */,	//本区仅“封闭测试账号”登陆，请选择其它区登录。
};
...
enum GameGateErrCode
{
	...
	GGERR_Kickoff_DecodeFailed    	= 3100      ,	//与服务器的连接被强行中断！\n连接时间可能超过限制，\n或者用户请求重新连接。
	GGERR_Kickoff_AreURobot       	/*3101    */,	//与服务器的连接被强行中断！\n连接时间可能超过限制，\n或者用户请求重新连接。
};
...
enum DBServerErrCode
{
	...
	DBERR_Not_This_Role_OfflineTrustee	/*6016    */,	//您有角色正在离线群英模式中，暂时不能使用其他角色
	DBERR_This_Role_OfflineTrustee	/*6017    */,	//该角色真正群英模式中
...
extern const char* SDGetErrDesc(int nErrcode);
#endif
