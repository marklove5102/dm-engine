...
static void SDES(char Out[8], const char In[8], const PSubKey pSubKey, bool Type);//标准DES加/解密
...
void SDES(char Out[8], const char In[8], const PSubKey pSubKey, bool Type)
{
...
bool CDes::Des_Go(char *Out, const char *In, long datalen, const char *Key, int keylen, bool Type)
{
