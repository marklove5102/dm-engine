...
class ExceptionReport
{
	...
	// where dump report is generated, which can be used to anlysis crash
	static LONG GenerateDumpReport(PEXCEPTION_POINTERS pExceptionInfo);
	...
	static TCHAR m_szCrashReporter[MAX_PATH];
