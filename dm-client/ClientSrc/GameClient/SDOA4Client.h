...
typedef BOOL (CALLBACK *LPLOGINCALLBACKPROC)(int nErrorCode, const s_LoginResult* pLoginResult, int nUserData, int nReserved);
...
public:
	...
	virtual void _stdcall Set_RevertChannel(ICommonChannelNew *pReverter) = 0;
	virtual ICommonChannelNew* _stdcall Get_RevertChannel(void) = 0;
...
typedef ICommonChannelNew *PCommonChannelNew;

typedef BOOL (WINAPI *LPCREATECHANNEL)(LPCSTR szChannelType, ICommonChannelNew **pChannel);
